$(document).ready(function(){
    $("#btn_login").click(function(){
        ...
        $.ajax({
            ...
            // data: {param1: 'value1'},
            data: "useremail=" + useremail + "&userpass=" + userpass + "&action=" + action ,
            success: function(res){
                if(res.trim()=='true'){
                    window.location.href = "home.html";             //  page directed to patient home page
    ...
    $("#btn_register").click(function(){
        ...
        var userpass = $("#userpassReg").val();
        var conpass = $("#ConUserpassReg").val();
        var action = "register";
        if (userpass==conpass) {
            $.ajax({
                url: 'php/login.php',
                ...
                // dataType: 'default: Intelligent Guess (Other values: xml, json, script, or html)',
                // data: {param1: 'value1'},
                data: "useremail=" + useremail + "&userpass=" + userpass + "&username=" + username + "&action=" + action,
                success: function(res){
                    if(res.trim()=='true'){
                        window.location.href = "home.html";             //  page directed to patient home page
                    } else if(res.trim()=='false'){
